...
insert into object_property select currval('object_id_seq'), property.id, 'yes' from property where property.name = 'Special';
...
insert into object_property select currval('object_id_seq'), property.id, '13.2' from property where property.name = 'Price';
insert into object_property select currval('object_id_seq'), property.id, '2.34' from property where property.name = 'Weight';
insert into object_property select currval('object_id_seq'), property.id, 'yes' from property where property.name = 'Front-page';
